...
export default {
  ...
  name: '/search',
  meta,
  redirect: { path: '/search/index' },
  component: layoutHeaderAside,
  children: [
    { path: 'index', name: '/search/index', component: _import('lds_search/index'), meta: { ...meta, title: '情报搜索' } },
    { path: 'result', name: '/search/result', component: _import('lds_search/result'), meta: { ...meta, title: '情报搜索' } },
    { path: 'result_next', name: '/search/result_next', component: _import('lds_search/result_next'), meta: { ...meta, title: '情报搜索' } },
    // { path: 'result_article', name: '/search/result_article', component: _import('lds_search/result_article'), meta: { ...meta, title: '情报搜索' } },
