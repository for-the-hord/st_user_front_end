...
$packages["main"] = (function() {
	...
	main = function() {
		...
		sheet.innerHTML = $externalize("html, body { \n\t\t\tpadding:0; margin:0; border:0; width:100%; height:50%; overflow:hidden;\n\t\t}\n\t\thtml{\n\t\t\tbackground: black;\n\t\t}", $String);
		...
		$global.addEventListener($externalize("load", $String), $externalize((function $b() {
			...
			rain1 = [rain1];
			rain2 = [rain2];
			lowGlyphCanvases = new sliceType([NewGlyphCanvas("#2196f3"), NewGlyphCanvas("#2196f3")]);
			highGlyphCanvases = new sliceType([NewGlyphCanvas("#2196f3"), NewGlyphCanvas("#2196f3")]);
			...
			cover.style.height = $externalize("50%", $String);
			cover.style.width = $externalize("100%", $String);                     //radial-gradient
			cover.style[$externalize("background-image", $String)] = $externalize("radial-gradient( #00FFFF , #0000FF)", $String);
	...
	NewGlyphCanvas = function(color) {
		...
		glyphCanvas.jso.width = 500;
		glyphCanvas.jso.height = 500;
		ctx = glyphCanvas.jso.getContext($externalize("2d", $String));
		col = 0;
		row = 1;
		_ref = "011111111111111111111111111111111111111111110101";
		_i = 0;
		while (true) {
			if (!(_i < _ref.length)) { break; }
