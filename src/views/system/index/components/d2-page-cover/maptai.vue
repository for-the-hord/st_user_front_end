<template>
  <div class="bg">
    <div class="bg_tt">
      <p style="color:white;font-size:16px">攻击区域分布</p>
...
export default {
  ...
  methods: {
    gomap() {
      this.worldData = this.map_lds_data;
      this.chinaConfigure(this.value);
       this.max = this.map_lds_data[0].value;
        ...
        tooltip: {
          ...
          formatter: function (params) {
            ...
            value =
              ...
              "." +
              value[1];
            return params.name + "<br/>" + "威胁组织数量" + " : " + params.value;
          },
        },
        visualMap: {
            show:false,
