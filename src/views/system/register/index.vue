          ...
          <div class="page-login--form">
            ...
            <el-form ref="loginForm" :rules="rules" :model="formLogin" size="default">
              ...
              <el-form-item prop="phone" label="手机号">
                <el-input v-model="formLogin.phone" placeholder="手机号"> </el-input>
              </el-form-item>
...
import { setRegister } from '@/common/login.js';
...
export default {
  ...
  data() {
    ...
    return {
      ...
      //   "name": "测试用户", //用户名称
      // "phone": "18322222222", //注册手机号
      // "password": "test1234", //密码
      // "password_again": "test1234" //确认密码
      // 表单校验
      rules: {
        name: [
          {
    ...
    submit() {
      this.$refs.loginForm.validate((valid) => {
        if (valid) {
          ...
          setRegister(this.formLogin).then((res) => {
