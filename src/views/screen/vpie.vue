...
export default {
  ...
  created() {
    console.log(this.activity, "activityactivityactivity");
  },
  methods: {
    map() {
      setTimeout(() => {
        var myChart = this.$echarts.init(document.getElementById("vpie"));
        window.onresize = myChart.resize;

        let num = 0;
        let colors = ["#FF9532", "#FF375F", "#6BBFFF", "#4a73d6"];
        let index = 0;
        let pieData = this.activity;
        // let pieData = [
        //   {
        //     name: "林业碳汇",
        //     value: 7.76,
        ...
        var option = {
          ...
          series: [
            ...
            //         cy: api.getHeight() / 2,
            //         r:
            //           (Math.min(api.getWidth(), api.getHeight()) / 2.21) *
            //           0.545,
