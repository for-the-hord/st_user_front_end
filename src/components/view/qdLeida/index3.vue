...
// zero_trust_score: 61
        ...
        const average = [this.activity.score, this.activity.zero_fault_score,
        this.activity.zero_loss_score,
        this.activity.zero_peril_score,
        this.activity.zero_trust_score,]
